...
<body >
	...
	<h1 align="center" class="fonte" style="font-size: 3em">Lista de todas petições</h1>
<a href="peticao.php"><button  class="btn btn-default hover" style="float: right; margin-right: 4px;">Publicar uma petição</button></a>
...
<table class="table table-hover">
	...
	<tr>
		...
		<td class="fonte2"><?php echo utf8_encode($dado["id_peticao"]); ?></td>
		<td class="fonte2"><?php  echo utf8_encode($dado["titulo"]); ?></td>
		<td class="fonte2"><?php  echo utf8_encode($dado["link"]); ?></td>
	
		<td class="fonte2">

			<a style="margin-left: 2px;" href="javascript: if(confirm('Tem certeza que deseja deletar a petição 
			<?php echo $dado["titulo"].' ?'; ?>')) 
			location.href='deletarpeticao.php?p=excluir&peticao=<?php echo $dado['id_peticao']; ?>';">Excluir</a> 
