...
$valor_pesquisar  =  utf8_decode((isset($_GET['pesquisar'])))? $_GET['pesquisar'] : 'inicio'; 


if ($valor_pesquisar == 'inicio'){
	header('location: verpublicacao.php');
}

$consulta = "SELECT *,usuario.nome as nomeUsuario, usuario.foto as foto FROM publicacao inner join usuario on publicacao.id_usuario = usuario.id_usuario where  tema like '%$valor_pesquisar%' ORDER BY data_hora DESC";
...
<a href="verpublicacao.php"><button  class="btn btn-default hover" style="float: right; margin-right: 4px;">Todas publicações</button></a><br>
