...
if (empty($conteudo)) {
	echo "<script>alert('Preencha o campo de comentário'); location.href='../foruminicio.php';</script>";
}
...
if ($inserir) {
	echo "<script>alert('comentario postado com sucesso'); history.back();</script>";
}else{
	mysqli_erro();
}
