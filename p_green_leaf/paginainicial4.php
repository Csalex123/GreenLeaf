...
$query =  mysqli_query($conexao, "SELECT  * FROM noticia WHERE id_noticia = 4  LIMIT 1");
 ...
 <center>
  <div class="img-responsive ">
     ...
     <header><p style="text-align: center; font-size: 17px; color: black; font-family: 'Montserrat', sans-serif;">
      <b> <?php  $titulo = utf8_encode($_SESSION['titulo']); echo $titulo;  ?></b>
    </p>
  </header><br>
...
<center>
  <nav aria-label="...">
    <ul class="pagination pagination-lg">
      ...
      <li class="page-item"><a class="page-link" href="paginainicial3.php">3</a></li>
      <li class="page-item"><a class="page-linka active " href="#">4</a></li>
    </ul>
  </nav>
</center> 
